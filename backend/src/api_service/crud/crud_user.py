...
from api_service.core.security import create_password_hash, verify_password
    ...
    async def get_devices(
        ...
        *,
        ...
        if active_only:
            ...
            query = query.where(or_(Device.is_active == True, Device.is_active.is_(None)))  # noqa: E712
